...
public class Note_Linked_List {
	...
	public void Screen1() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Note_Linked_List window = new Note_Linked_List();
	...
	private void initialize() {
		...
		JLabel lblNewLabel_7 = new JLabel("Linked list Version");
		lblNewLabel_7.setBounds(424, 10, 194, 48);
